...
ALTER TABLE  t_admin  CHARACTER SET utf8;
alter table t_admin change name name varchar(20) character set utf8;
...
alter table t_data change content content text character set utf8;
...
alter table t_room change name name varchar(20) character set utf8;
